                    ...
                    <div class="txtLeft col-md-12">
                      ...
                      <ul>
                        ...
                        <li>
                          <div>
                            <p>
                              Renomeie a imagem principal como "<?php echo $img['img1']; ?>".
                            </p>
                          </div>
                        </li>
                        ...
                        <li>
                          <div>
                            <p>
                              Renomeie a segunda imagem como "<?php echo $img['img2']; ?>".
                            </p>
                          </div>
                        </li>
                        ...
                        <li>
                          <div>
                            <p>
                              Renomeie a terceira imagem como "<?php echo $img['img3']; ?>".
                            </p>
                          </div>
                        </li>
                      </ul>
